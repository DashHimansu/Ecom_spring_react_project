...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  //         response = await axios.get(`http://localhost:8091/api/products/search?id=${value}`);
  //       } else {
  //         // Input is not a number, search by keyword
  //         response = await axios.get(`http://localhost:8091/api/products/search?keyword=${value}`);
  //       }
